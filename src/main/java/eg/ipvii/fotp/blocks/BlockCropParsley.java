...
public class BlockCropParsley extends BlockCrops{
    ...
    public BlockCropParsley(){
        setUnlocalizedName(References.FotPBlocks.PARSLEYCROP.getUnlocalizedName());
        setRegistryName(References.FotPBlocks.PARSLEYCROP.getRegistryName());
    }
